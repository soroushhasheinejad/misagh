...
const LABELS: Record<SettingKey, string> = {
  ...
  "seo.siteName": "نام سایت",
  "seo.titleDefault": "عنوان پیش‌فرض صفحه اصلی",
  "seo.titleTemplate": "الگوی عنوان صفحه‌ها",
  "seo.defaultDescription": "توضیح متای پیش‌فرض",
  "seo.defaultOgImage": "تصویر اشتراک‌گذاری پیش‌فرض",
  "seo.googleVerification": "کد تایید سرچ کنسول",
  "seo.productSchemaEnabled": "اسکیمای محصول",
  "seo.faqSchemaEnabled": "اسکیمای پرسش و پاسخ",
  "seo.breadcrumbSchemaEnabled": "اسکیمای مسیر راهنما",
  "seo.organizationSchemaEnabled": "اسکیمای کسب‌وکار",
  "seo.sitemapParts": "قطعات در نقشه سایت",
  "seo.sitemapOem": "شماره‌های فنی در نقشه سایت",
  "seo.sitemapCars": "صفحه‌های خودرو در نقشه سایت",
  "seo.sitemapPosts": "مقاله‌ها در نقشه سایت",
  "seo.autoNoindexThin": "خروج خودکار صفحه‌های کم‌محتوا از ایندکس",
  "seo.thinWordThreshold": "آستانه کم‌محتوا (کلمه)",
