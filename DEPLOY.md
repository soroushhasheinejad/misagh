...
بیلد بار اول بسته به سرعت اینترنت ممکن است ۵ تا ۲۰ دقیقه طول بکشد؛ بیشترش صرف نصب
پکیج‌هاست. دفعات بعد از کش استفاده می‌شود و سریع است.

**اگر نصب پکیج‌ها با خطای شبکه شکست:** روی اینترنت ایران، `npm` گاهی وسط دانلود
`ECONNRESET` می‌دهد. Dockerfile خودش تا پنج بار تلاش می‌کند و هر تلاش از کش ادامه
می‌دهد، پس معمولاً بار دوم یا سوم تمام می‌شود. اگر باز هم نشد، با آینه رجیستری بسازید:
...
از پنل می‌توانید کل کاتالوگ را مدیریت کنید: ساخت و ویرایش قطعه، شماره فنی، سازگاری
خودرو، پیشنهاد فروش و تصویر؛ درخت خودرو، دسته، برند و تامین‌کننده؛ قاعده‌های شماره
شاسی؛ نرخ ارز، قیمت، موجودی، سفارش، استعلام و مقاله. بخش «سئو» هم محتوای هر صفحه،
قالب‌ها، تولید گروهی، گزارش‌ها، ریدایرکت و تنظیمات سئو را در بر می‌گیرد. لینک پنل در سربرگ سایت نیست و برای بازدیدکننده
...
تصویرهای آپلودشده در `public/uploads` می‌نشینند. در داکر این پوشه volume دارد، پس با
بیلد بعدی پاک نمی‌شود. اگر بدون داکر اجرا می‌کنید، این پوشه را در پشتیبان‌گیری
بگنجانید — چون داخل دامپ دیتابیس نیست.
