...
**میلی‌سرچ و ردیس لازم نیستند.** در فایل `docker-compose.yml` هستند ولی کد فعلاً به
هیچ‌کدام وصل نمی‌شود؛ برای فازهای بعدی گذاشته شده‌اند. فقط پستگرس را بالا بیاورید.
